...
CREATE DEFINER=`root`@`localhost` PROCEDURE `transaction`(in vnombre<br> varchar(50), in vprecio decimal(10,2), in vstock int, in vcategoria
varchar(45), in vestado varchar(45)) 
BEGIN
start transaction;
